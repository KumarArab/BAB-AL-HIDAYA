...
const en = {
  ...
  company: {
    ...
    legalNameAlt: 'باب الهداية لخدمات التنظيف - شركة الشخص الواحد ذ.م.م',
    shortPitch:
  ...
  address: {
    line1: 'Office 12, Building 4',
    line2: 'Al Jurf Industrial Area 2',
    poBox: 'P.O. Box 12345',
    city: 'Ajman',
  ...
  registration: {
    ...
    legalForm: 'Single Person Company L.L.C (S.P.S. L.L.C)',
    legalFormShort: 'S.P.S. L.L.C, Ajman',
    licenceIssued: '14 March 2019',
    licenceExpiry: '13 March 2027',
    chamber: (n: string) => `Ajman Chamber of Commerce & Industry: Member No. ${n}`,
    ejari: 'Registered commercial office (tenancy contract) in Al Jurf, Ajman',
    activities: [
  ...
  stats: ['Years in operation', 'Trained staff', 'Active client contracts', 'Emirates covered'],
  ...
  leadership: [
    ...
    { name: 'Rajesh Menon', role: 'Operations Manager', bio: 'MEP engineer with 15 years of building maintenance experience across the UAE. Leads technical teams and AMC delivery.' },
  ...
  services: [
    ...
    },
    {
      ...
      summary: 'Municipality-approved water tank cleaning, disinfection and pest control coordination.',
      intro: 'UAE municipalities require regular cleaning of building water tanks. We clean, disinfect and certify tanks and provide the documentation your building needs.',
  ...
  home: {
    ...
    credApprovalsVal: 'Municipality · MOHRE',
    ...
    reasons: [
      { title: 'Fully licensed & insured', text: 'Ajman DED-licensed company with municipality approvals and AED 2M liability cover.' },
  ...
  about: {
    ...
    p2: 'We started with a small team of cleaners and technicians in Ajman. Today we supply trained staff by the hour, day, week or month, and run maintenance contracts for villas, towers, offices, shops and schools across all seven emirates.',
    ...
    milestones: [
      { year: '2019', text: 'Company registered in Ajman and trade licence issued by Ajman DED.' },
      { year: '2020', text: 'Hourly and monthly cleaner service launched for homes and offices.' },
      ...
      { year: '2024', text: 'Services extended to all seven emirates. Workforce passes 100.' },
      { year: '2026', text: '85+ active contracts with homes and businesses across the UAE.' },
    ],
  },
  ...
  licencesPage: {
    ...
    docs: ['Trade Licence (Ajman DED)', 'VAT Registration Certificate', 'Memorandum of Association', 'ISO 9001 / 14001 / 45001 Certificates', 'Insurance Certificates', 'Municipality Approvals', 'Company Profile', 'HSE Policy & Manual'],
